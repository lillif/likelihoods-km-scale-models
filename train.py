...
from src.utils.hydra import find_hydra_run_path, load_ckpt_from_hydra_run
...
def main(config: DictConfig):
    ...
    if log_metrics:
        raise NotImplementedError(
            "Logging additional metrics to wandb is not implemented yet for normalising flows."
        )
